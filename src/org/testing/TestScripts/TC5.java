...
//	}
	...
	public void tc() throws InterruptedException {
		...
		WebElement chanelsub=driver.findElement(By.xpath("//yt-formatted-string[@class='style-scope ytd-subscribe-button-renderer']"));
	//	js.executeScript("arguments[0].scrollIntoView(true);",chanelsub);
		Thread.sleep(3000);
		chanelsub.click();
		Thread.sleep(3000);
