...
//	}
	...
	public void tc() throws InterruptedException {
		...
		Thread.sleep(3000);
		WebElement history=driver.findElement(By.xpath("(//paper-item[@role='tab' and @class='style-scope ytd-guide-entry-renderer'])[5]"));
		history.click();
		Thread.sleep(6000);
		...
		WebElement logout=driver.findElement(By.xpath("(//paper-item[@role='link'])[8]"));
		logout.click();
		Thread.sleep(3000);
